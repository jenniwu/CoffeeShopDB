...
import front_end.view_information.joinedSalary;
 ...
 */
public class employee_identify_for_salary {
    ...
    public employee_identify_for_salary(String userType)
    {
    ...
    private void gui(){
        ...
        submitButton.addActionListener(e -> {
            ...
            if(!employeeOra.isValidEID(eId)) {
                ...
                new joinedSalary(salaryOra.getSalariesByEmployee(eId),"employee");
            }
        });
